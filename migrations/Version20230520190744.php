...
final class Version20230520190744 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE IF NOT EXISTS `user` (`id` INT(10) NOT NULL AUTO_INCREMENT , `name` VARCHAR(50) NOT NULL , `email` VARCHAR(60) NOT NULL , `password` VARCHAR(30) NOT NULL , `roles` VARCHAR(25) NOT NULL DEFAULT '[\"user\"]' , `is_active` TINYINT(1) NOT NULL DEFAULT '1' , `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , `updated_at` DATETIME on update CURRENT_TIMESTAMP NULL , `deleted_at` DATETIME NULL , PRIMARY KEY (`id`), UNIQUE `email` (`email`)) ENGINE = InnoDB");
    }
